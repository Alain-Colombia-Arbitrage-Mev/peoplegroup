                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-red-sunglo">
                                    ...
                                    <span class="caption-subject bold uppercase">Métodos de pago</span>
                                </div>
                            </div>
                                            ...
                                            <div class="panel panel-primary">
                                                ...
                                                <div class="panel-body">
                                                    <ul class="list-group">
                                                        ...
                                                        <li class="list-group-item"><h4  class="btn btn-block btn-{{$gateway->status == 1 ? 'success' : 'danger'}}">{{$gateway->status == 1 ? 'Activo' : 'Inactivo'}}</h4></li>
                                                    </ul>
                                                </div>
                                            ...
                                            <form role="form" method="POST" action="{{url('admin/gateway')}}/{{$gateway->id}}" enctype="multipart/form-data">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <strong class="col-md-12" class="modal-title">Editar {{$gateway->name}}</strong>
                                                    </div>
                                                    <div class="modal-body">
                                                            ...
                                                            <div class="modal-body">
                                                                   ...
                                                                   <div class="form-group">
                                                                       <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        ...
                                                                        <span class="btn btn-success btn-file">
                                                                            <span class="fileinput-new"> Cambiar Logo </span>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <strong class="col-md-12">Nombre</strong>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <strong class="col-md-12" >Cargo fijo</strong>
                                                                ...
                                                                <div class="form-group">
                                                                    <strong class="col-md-12">Cargo en porcentaje</strong>
                                                                ...
                                                                <div class="form-group">
                                                                    <strong class="col-md-12" >Valor mínimo</strong>
                                                                    <div class="input-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <strong class="col-md-12" >Valor máximo</strong>
                                                                ...
                                                                <div class="form-group">
                                                                    <strong class="col-md-12">Tasa de conversión</strong>
                                                                ...
                                                                @elseif($gateway->id==10)
                                                                <!-- SMART FIELD -->
                                                                <div class="form-group">
                                                                    <strong class="col-md-12" for="val1">Smart contract Address</strong>
                                                                    <input type="text" value="{{$gateway->val1}}" class="form-control" id="val1" name="val1" >
                                                                </div>
                                                                <!-- <div class="form-group">
                                                                    <strong class="col-md-12" for="val2">Merchant Id</strong>
                                                                ...
                                                                @else
                                                                    <div class="form-group">
                                                                        <strong class="col-md-12" for="val1">Detalles del pago</strong>
                                                                        <input type="text" value="{{$gateway->val1}}" class="form-control" id="val1" name="val1" >
                                                                    </div>
                                                                @endif
                                                                <hr/>
                                                                <div class="form-group">
                                                                    <strong class="col-md-12" for="status">Estado</strong>
                                                                    <select class="form-control" name="status">
                                                                        <option value="1" {{ $gateway->status == "1" ? 'selected' : '' }}>Activo</option>
                                                                        <option value="0" {{ $gateway->status == "0" ? 'selected' : '' }}>Inactivo</option>
                                                                    </select>
