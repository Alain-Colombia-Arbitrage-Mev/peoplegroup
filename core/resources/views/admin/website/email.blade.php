...
<div class="row">
	<div class="col-md-12">
		<h2>Configuración Plantilla de Email</h2>
		<hr/>
	</div>
</div>
<div class="row">
			...
			<div class="portlet light bordered">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject font-blue-sharp bold uppercase">Plantilla Email y SMS</span>
					</div>
				</div>
				<div class="portlet-body form">
					<form role="form" method="POST" action="{{route('template.update')}}" enctype="multipart/form-data">
						...
						<div class="form-actions">
							<button type="submit" class="btn green btn-block btn-lg">Guardar</button>
						</div>
					</form>
				</div>
			</div>
