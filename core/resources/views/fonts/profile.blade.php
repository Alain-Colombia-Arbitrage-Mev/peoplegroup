                ...
                <div class="col-md-12">
                    <div class="portlet box dark">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-th"></i> Actualizar mi perfil
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group col-md-12">
                                            <div class="col-md-6 {{ $errors->has('first_name') ? ' has-error' : '' }}">
                                                <strong class="col-md-12">Nombres</strong>
                                        ...
                                        <strong>{{ $errors->first('first_name') }}</strong>
                                            ...
                                            <div class="col-md-6 {{ $errors->has('last_name') ? ' has-error' : '' }}">
                                                <strong class="col-md-12">Apellidos</strong>
                                        ...
                                        <strong>{{ $errors->first('email') }}</strong>
                                            ...
                                            <div class="col-md-6 {{ $errors->has('mobile') ? ' has-error' : '' }}">
                                                <strong class="col-md-12">Celular</strong>
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="col-md-4{{ $errors->has('street_address') ? ' has-error' : '' }}">
                                                <strong class="col-md-12">Dirección </strong>
                                            ...
                                            <div class="col-md-4{{ $errors->has('city') ? ' has-error' : '' }}">
                                                <strong class="col-md-12">Ciudad</strong>
                                            ...
                                            <div class="col-md-4{{ $errors->has('country') ? ' has-error' : '' }}">
                                                <strong class="col-md-12">País</strong>
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" style="margin-top: 40px;" class="btn-primary btn btn-lg btn-block">Actualizar</button>
                                        </div>
                                    </div>
                                        </div>
