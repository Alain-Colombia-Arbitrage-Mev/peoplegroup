                ...
                <div class="col-md-12">
                    <div class="portlet box blue-ebonyclay">
                        <div class="portlet-title">
                            <div class="caption uppercase bold"><i class="fa fa-th"></i> Resumen - añadir fondos</div>
                        </div>
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="panel panel-inverse">
                                        <div class="panel-heading">
                                            <h3 class="text-center bold">Resumen - Añadir fondos</h3>
                                        </div>
                                        <div class="panel-body table-responsive text-center">
                                            <ul class="list-group">
                                                <li class="list-group-item">Fondos a añadir: <strong>{{$amount}}</strong> {{$general->currency}}</li>
                                                ...
                                                @else
                                                    ...
                                                    <li class="list-group-item" style="color: red">Cargos: <strong>{{$charge}}</strong> {{$general->currency}}</li>
                                                    <li class="list-group-item">Valor total a pagar: <strong>{{$one + $two}}</strong> {{$general->currency}}</li>
                                                    <li class="list-group-item" style="color: firebrick">En USD: <strong>{{number_format(($one + $two)/$gate->rate, 2) }}</strong> USD</li>

                                                    <li class="list-group-item">Forma de pago: <strong>{{$gate->name}}</strong></li>
                                                @endif
                                            </ul>
                                        </div>
