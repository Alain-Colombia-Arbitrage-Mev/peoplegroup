                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-heading has-btn">
                            ...
                            <div class="the-btn">
                                ...
                                @endif
                                <a href="{{route('ticket.close', $ticket_object->ticket)}}" class="btn btn-danger  make-close-support" style="height: 35px;">Clic para cerrar ticket</a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <form method="POST" class="form-horizontal" action="{{route('store.customer.reply', $ticket_object->ticket)}}" accept-charset="UTF-8" >
                                            ...
                                            @foreach($ticket_data as $data)
                                                <div class="panel-body">
                                                    <fieldset class="col-md-12">
                                                        @if($data->type == 1)
                                                            <legend><span style="color: #0e76a8">{{Auth::user()->first_name}}</span> , <small>{{ \Carbon\Carbon::parse($data->updated_at)->format('Y-m-d H:i:s') }}</small></legend>
                                                        @else
                                                            <legend><span style="color: #0e76a8">{{$general->web_title}}</span> , <small>{{ \Carbon\Carbon::parse($data->updated_at)->format('Y-m-d H:i:s') }}</small></legend>
                                                        @endif
                                    ...
                                    <div class="form-group {{ $errors->has('comment') ? ' has-error' : '' }}">
                                        <div class="col-md-12">
                                            <label class="col-md-12 bold">Nuevo Mensaje: </label>
                                            <div class="col-md-12">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-check"></i> Enviar</button>
                                        </div>
