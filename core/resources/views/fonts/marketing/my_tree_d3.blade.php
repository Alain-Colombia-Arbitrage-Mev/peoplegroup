...
@section('main-content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <p><span class="text-muted"> Hasta el nivel 10</span></p>
            ...
            <script type="text/javascript">
              ...
              var TreeUserUrl = "{{ route('tree.user') }}";

            </script>

            <div id="full-container">
              <!-- <button class="btn-action btn-fullscreen" onclick="params.funcs.toggleFullScreen()">Pantalla Completa <span class='icon'/> <i class="fa fa-arrows-alt" aria-hidden="true"></i></span></button> -->
              <button class="btn-action btn-show-my-self" onclick="params.funcs.showMySelf()"> Mostrar solo mis directos <span class='icon'/> <i class="fa fa-user" aria-hidden="true"></i></span></button>

              <button class=" btn-action btn-search" onclick="params.funcs.search()"> Buscar <span class='icon'/> <i class="fa fa-search" aria-hidden="true"></i></span></button>
              ...
              <div class="user-search-box">
                <div class="input-box">
                  ...
                  <div class="input-wrapper">
                    ...
                    <div class="input-bottom-placeholder">Por Nombre y apellido Tags</div>
                  </div>
                  <div>
                  </div>
                </div>
...
function drawOrganizationChart(params) {
  ...
  function reflectResults(results) {
    var htmlStringArray = results.map(function(result) {
      ...
      strVar += "              <a target='_blank' href='"+result.profileUrl+"'><button class='btn-search-box btn-action'>Ver Perfil<\/button><\/a>";
